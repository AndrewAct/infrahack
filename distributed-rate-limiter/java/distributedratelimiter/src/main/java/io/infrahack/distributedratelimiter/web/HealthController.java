...
public class HealthController {
    ...
    /** Pings Postgres when configured; always ready in the default in-memory rule mode. */
    ...
    public ResponseEntity<Map<String, String>> ready() {
        ...
        return ResponseEntity.status(status).body(Map.of("status", ready ? "ready" : "not_ready"));
    }
}
